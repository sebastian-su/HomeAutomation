...
RSpec.configure do |config|
  config.before(:each) do
    ...
    stub_request(:get, "http://fritz.box/webservices/homeautoswitch.lua?ain=123&sid=&switchcmd=setswitchoff").
      with(:headers => {'Accept'=>'*/*', 'User-Agent'=>'Ruby'}).
      to_return(:status => 200, :body => "", :headers => {})
    stub_request(:get, "http://fritz.box/webservices/homeautoswitch.lua?ain=123&sid=&switchcmd=setswitchon").
      with(:headers => {'Accept'=>'*/*', 'User-Agent'=>'Ruby'}).
      to_return(:status => 200, :body => "", :headers => {})
    ...
    stub_request(:get, "http://fritz.box/webservices/homeautoswitch.lua?ain=456&sid=&switchcmd=setswitchoff").
      with(:headers => {'Accept'=>'*/*', 'User-Agent'=>'Ruby'}).
      to_return(:status => 200, :body => "", :headers => {})
    stub_request(:get, "http://fritz.box/webservices/homeautoswitch.lua?ain=456&sid=&switchcmd=setswitchon").
      with(:headers => {'Accept'=>'*/*', 'User-Agent'=>'Ruby'}).
      to_return(:status => 200, :body => "", :headers => {})
    stub_request(:get, "http://fritz.box/webservices/homeautoswitch.lua?ain=456&sid=&switchcmd=getswitchname").
      with(:headers => {'Accept'=>'*/*', 'User-Agent'=>'Ruby'}).
      to_return(:status => 200, :body => "switchname", :headers => {})
